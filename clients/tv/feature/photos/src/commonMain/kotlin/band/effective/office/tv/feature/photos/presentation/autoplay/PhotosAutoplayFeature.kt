package band.effective.office.tv.feature.photos.presentation.autoplay

import androidx.compose.runtime.Composable
import androidx.compose.runtime.remember
import band.effective.office.tv.feature.photos.presentation.PhotosComponent
import band.effective.office.tv.feature.photos.presentation.PhotosIntent
import band.effective.office.tv.feature.photos.presentation.PhotosScreen
...
class PhotosAutoplayFeature(
    ...
    private val component = PhotosComponent(
        componentContext = componentContext,
    ...
    override val navigationHandler: NavigationHandler = object : NavigationHandler {
        override fun onNext(): Boolean {
            component.onIntent(PhotosIntent.Next)
            return true
        }
        ...
        override fun onPrevious(): Boolean {
            ...
            component.onIntent(PhotosIntent.Previous)
            return true
        }
    }
